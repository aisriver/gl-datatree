...
var _threeGltfLoader = _interopRequireDefault(require("three-gltf-loader"));
...
var leafs;
var leafLoader = new _threeGltfLoader["default"](); // 轮播对象的id
...
var renderTree = function renderTree(props) {
  ...
  data.forEach(function (item, index) {
    ...
    ? restParams.position : (0, _position.getNodePosition)({
      level: level,
    ...
    if (!isFirstNode) {
      ...
      var link = (0, _create.createCylinderMesh)(linkMeshConfig); // 弯曲管道连线
...
var createDataTree = function createDataTree() {
  ...
  var trunk = (0, _create.createCylinderMesh)({
    startWidth: 0.4,
    endWidth: 0.8,
    startPosition: startPosition,
    endPosition: endPosition,
