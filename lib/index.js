...
var _datatree = _interopRequireDefault(require("./utils/datatree"));
...
var GlDataTree = /*#__PURE__*/function () {
  function GlDataTree() {
    ...
    this.handleMousemove = function (e, dom) {
      ...
      var _getDomInfo = (0, _dom.getDomInfo)(dom),
          x = _getDomInfo.x,
          y = _getDomInfo.y,
  ...
  _createClass(GlDataTree, [{
    ...
    value: function initRenderer(props) {
      ...
      if (this.dom) {
        var _getDomInfo2 = (0, _dom.getDomInfo)(this.dom),
    ...
    value: function initCamera() {
      if (this.dom && this.renderer) {
        var _getDomInfo3 = (0, _dom.getDomInfo)(this.dom),
      ...
      if (length > 0) {
        ...
        raf.setInterval(function () {
          ...
          if (currentMesh && currentMesh.userData) {
            var userData = currentMesh.userData;
            var domPosition = (0, _position.toWindowPosition)({
              obj: currentMesh,
              camera: camera,
              domInfo: (0, _dom.getDomInfo)(dom)
            });
    ...
    value: function init(glDom) {
      ...
      return {
        ...
        updateTooltip: _tooltip.updateTooltip,
